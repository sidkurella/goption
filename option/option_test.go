...
func TestOption_And(t *testing.T) {
	t.Run("Some, Some", func(t *testing.T) {
		res := option.And(option.Some(3), option.Some("test"))
		expected := option.Some("test")
		if res != expected {
			t.Fail()
		}
	})
	t.Run("Some, Nothing", func(t *testing.T) {
		res := option.And(option.Some(3), option.Nothing[string]())
	...
	t.Run("Nothing, Some", func(t *testing.T) {
		res := option.And(option.Nothing[int](), option.Some("test"))
		expected := option.Nothing[string]()
		if res != expected {
			t.Fail()
		}
	...
	t.Run("Nothing, Nothing", func(t *testing.T) {
		res := option.And(option.Nothing[int](), option.Nothing[string]())
		expected := option.Nothing[string]()
		if res != expected {
			t.Fail()
		}
...
func TestOption_AndThen(t *testing.T) {
	t.Run("Some, f returns Some", func(t *testing.T) {
		calls := 0
		res := option.AndThen(option.Some(3), func(t int) option.Option[string] {
			calls++
	...
	t.Run("Nothing, f not called", func(t *testing.T) {
		calls := 0
		res := option.AndThen(option.Nothing[int](), func(t int) option.Option[string] {
			calls++
			return option.Nothing[string]()
		})
		expected := option.Nothing[string]()
...
func TestOption_Or(t *testing.T) {
	t.Run("Some, Some", func(t *testing.T) {
		res := option.Some(3).Or(option.Some(4))
	...
	t.Run("Some, Nothing", func(t *testing.T) {
		res := option.Some(3).Or(option.Nothing[int]())
		expected := option.Some(3)
		if res != expected {
			t.Fail()
		}
	...
	t.Run("Nothing, Some", func(t *testing.T) {
		res := option.Nothing[int]().Or(option.Some(4))
		expected := option.Some(4)
		if res != expected {
			t.Fail()
		}
	})
...
func TestOption_OrElse(t *testing.T) {
	t.Run("Some, f not called", func(t *testing.T) {
		calls := 0
		res := option.Some(3).OrElse(func() option.Option[int] {
			calls++
...
func TestOption_Xor(t *testing.T) {
	t.Run("Some, Some", func(t *testing.T) {
		res := option.Some(3).Xor(option.Some(4))
		expected := option.Nothing[int]()
		if res != expected {
			t.Fail()
		}
	...
	t.Run("Some, Nothing", func(t *testing.T) {
		res := option.Some(3).Xor(option.Nothing[int]())
		expected := option.Some(3)
		if res != expected {
			t.Fail()
		}
	...
	t.Run("Nothing, Some", func(t *testing.T) {
		res := option.Nothing[int]().Xor(option.Some(4))
		expected := option.Some(4)
		if res != expected {
			t.Fail()
		}
...
func TestOption_Flatten(t *testing.T) {
	...
	t.Run("Some[Nothing]", func(t *testing.T) {
		res := option.Flatten(
			option.Some(option.Nothing[int]()),
		)
		expected := option.Nothing[int]()
		if res != expected {
			t.Fail()
...
func TestOption_Map(t *testing.T) {
	...
	t.Run("Nothing", func(t *testing.T) {
		res := option.Map(option.Nothing[int](),
			func(t int) string {
				return strconv.Itoa(t)
			},
		)
...
func TestOption_MapOr(t *testing.T) {
	t.Run("Some", func(t *testing.T) {
		res := option.MapOr(option.Some(4), "default",
			func(t int) string {
				return strconv.Itoa(t)
			},
		)
	...
	t.Run("Nothing", func(t *testing.T) {
		res := option.MapOr(option.Nothing[int](), "default",
			func(t int) string {
				return strconv.Itoa(t)
			},
		)
		expected := option.Some("default")
		if res != expected {
			t.Fail()
		}
	})
...
func TestOption_MapOrElse(t *testing.T) {
	t.Run("Some, default not called", func(t *testing.T) {
		calls := 0
		res := option.MapOrElse(option.Some(4),
			func() string {
				calls++
				return "default"
			},
	...
	t.Run("Nothing, default called", func(t *testing.T) {
		calls := 0
		res := option.MapOrElse(option.Nothing[int](),
			func() string {
				calls++
				return "default"
			},
...
func TestOption_Match(t *testing.T) {
	t.Run("Some", func(t *testing.T) {
		someArmCalls := 0
		nothingArmCalls := 0
		res := option.Match(option.Some(4),
			func(t int) string {
				someArmCalls++
				return strconv.Itoa(t)
			},
	...
	t.Run("Nothing", func(t *testing.T) {
		someArmCalls := 0
		nothingArmCalls := 0
		res := option.Match(option.Nothing[int](),
			func(t int) string {
				someArmCalls++
				return strconv.Itoa(t)
			},
